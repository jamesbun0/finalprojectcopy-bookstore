...
namespace FinalProject.Controllers
{
    public class CreditCardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CreditCardID,CreditCardNumber,CreditCardType")] CreditCard creditCard)
        {
            //store user's name
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CreditCardID,CreditCardNumber,CreditCardType")] CreditCard creditCard)
        {
