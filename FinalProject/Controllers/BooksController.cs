...
namespace FinalProject.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var book = await _context.Books.Include(r => r.Genre)
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookID,PublishedDate,UniqueID,Title,Description,Price,Author,Cost,Reorder,CopiesOnHand,LastOrdered,Active")] Book book)
        {
            if (id != book.BookID)
            {
                return NotFound();
